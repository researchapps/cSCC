...
<body>
    <div class="container" style="padding-top:100px">
        <div class="row">
            <div class="col-md-1">
                <ul class="nav nav-pills nav-stacked red" style="margin-top:40px">
                                    ...
                                    <form class="form-horizontal">
                                        <fieldset>
                                            ...
                                            <div class="form-group" id="past_rx_invasive_div">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><input checked id="past_rx_invasive" name="past_rx_invasive" type="checkbox"></span>
                                            ...
                                            <div class="form-group" id="past_rx_insitu_div" style='display:none'>
                                                <label class="col-md-3 control-label" for="past_rx_insitu">Related Diagnosis</label>
                                                <div class="col-md-8">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><input id="past_rx_insitu" name="past_rx_insitu" placeholder="in-situ squamous cell carcinoma" type="checkbox"></span>
                                            ...
                                            <div class="form-group" id="past_rx_keratosis_div" style='display:none'>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><input id="past_rx_keratosis" name="past_rx_keratosis" type="checkbox"></span>
                                            ...
                                            <div class="form-group" id='genotyped_div'>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><input id="genotyped" name="genotyped" type="checkbox"></span>
                                            ...
                                            <div class="form-group" id="risk_alleles_div" style="display:none">
                                                ...
                                                <div class="col-md-3">
                                                    <select class="form-control" id="risk_alleles" name="risk_alleles">
                                                        <option value="0">
                                                            less than 8
                                                        </option>
                                                        <option value="1">
                                            ...
                                            <div class="form-group" id="age_years_div">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        <input class="form-control" id="age_years" name="age_years" placeholder="65" required="" type="text"> <span class="input-group-addon">years</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group" id="gender_div">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="radio">
                                                        <label for="gender-0"><input checked="checked" id="gender-0" name="gender" type="radio" value="male"> Male</label>
                                                    </div>
                                                    <div class="radio">
                                                        <label for="gender-1"><input id="gender-1" name="gender" type="radio" value="female"> Female</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group" id="tendency_sunburn_div">
                                                ...
                                                <div class="col-md-3">
                                                    <select class="form-control" id="tendency_sunburn" name="tendency_sunburn">
                                                        <option value="0">
                                                            Low
                                                        </option>
                                                        <option value="1">
